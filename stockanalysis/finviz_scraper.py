...
class FinvizScraper:
    ...
    # NOTE: Reverse split detection logic commented out - no longer needed
    ...
    async def update_ticker_database(self):
        ...
        while attempt <= max_attempts:
            ...
            try:
                ...
                # NOTE: Reverse split checking logic commented out - no longer needed
                ...
                logger.info(f"✅ Scraped {len(tickers)} tickers from Finviz")
